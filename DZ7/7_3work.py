...
# в котором определить публичные атрибуты name,
# surname, position (должность),
# и защищенный атрибут income (доход).
# Последний атрибут должен ссылаться на словарь, содержащий элементы:
...
a = Position('Игорь', 'Петров', 'Оператор', 30000, 10000)
print(str.format('Игорь', 'Петров', 'Оператор', 30000, 10000))
